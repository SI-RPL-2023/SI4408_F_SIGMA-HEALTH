...
<head>
    ...
    <!-- Font Icon -->
    <link rel="stylesheet" href="<?php echo e(asset('assets/login/fonts/material-icon/css/material-design-iconic-font.min.css')); ?>">
    ...
    <link rel="stylesheet" href="<?php echo e(asset('assets/adminlte/datetimepicker-master/jquery.datetimepicker.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('assets/adminlte/plugins/summernote/summernote-bs5.min.css')); ?>">
<style>
    body, html{
  ...
  <div class="container">
    <a class="navbar-brand" href="/" style="font-size:15px;color:#fff">
      <div class="d-flex justify-content-between">
        <img src="<?php echo e(asset('assets/images/logo1.png')); ?>" alt="Logo" width="64" height="60" class="">
    ...
    <div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
        <ul class="navbar-nav">
            <li class="nav-item">
                <a href="<?php echo e(url('pendaftaran-pasien')); ?>" class="nav-link link-navbar">Pendaftaran</a>
            </li>
            <li class="nav-item">
                <a href="<?php echo e(url('poliklinik')); ?>" class="nav-link link-navbar">Jadwal Dokter</a>
            </li>
            <li class="nav-item">
                <a href="<?php echo e(url('form-obat')); ?>" class="nav-link link-navbar">Pengambilan Obat</a>
            </li>
            <li class="nav-item">
                <a href="<?php echo e(url('reservasi')); ?>" class="nav-link link-navbar">Cek Reservasi</a>
            </li>
        </ul>
    </div>
    ...
    <div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
        <ul class="navbar-nav">
            <li class="nav-item">
                <a href="<?php echo e(url('home-admin')); ?>" class="nav-link link-navbar">Home</a>
            </li>
            <li class="nav-item">
                <a href="<?php echo e(url('master-poli')); ?>" class="nav-link link-navbar">Master Poli</a>
            </li>
            <li class="nav-item">
                <a href="<?php echo e(url('master-dokter')); ?>" class="nav-link link-navbar">Master Dokter</a>
            </li>
            <li class="nav-item">
                <a href="<?php echo e(url('master-jadwal')); ?>" class="nav-link link-navbar">Master Jadwal</a>
            </li>
            <li class="nav-item">
                <a href="<?php echo e(url('master-obat')); ?>" class="nav-link link-navbar">Master Obat</a>
            </li>
            <li class="nav-item">
                <a href="<?php echo e(url('cek-reservasi-pasien')); ?>" class="nav-link link-navbar">Cek Reservasi</a>
            </li>
        </ul>
    </div>
    <?php endif; ?>
    ...
    <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
        <ul class="navbar-nav">
            <li class="nav-item">
                <?php if(Session::get('login') == null): ?>
                <a href="<?php echo e(url('login')); ?>" class="nav-link fw-semibold link-navbar">Log in</a>
                <?php else: ?>
                <a href="<?php echo e(url('doLogout')); ?>" class="nav-link fw-semibold link-navbar">Log out</a>
                <?php endif; ?>
            </li>
        </ul>
    </div>
  ...
  <footer class="w-100 py-4 flex-shrink-0">
        <div class="container py-4">
            <div class="row gy-4 gx-5">
                ...
                <div class="col-lg-4 col-md-6">
                    <!-- <img src="<?php echo e(asset('assets/images/maps.png')); ?>" alt=""> -->
...
<script src="<?php echo e(asset('assets/pendaftaran/js/owl.carousel.min.js')); ?>"></script>
<script src="<?php echo e(asset('assets/pendaftaran/js/main.js')); ?>"></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/limonte-sweetalert2/11.6.16/sweetalert2.min.js"></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery.mask/1.14.16/jquery.mask.min.js"></script>
<script src="<?php echo e(asset('assets/adminlte/datetimepicker-master/jquery.datetimepicker.js')); ?>"></script>
<!-- <script src="https://cdnjs.cloudflare.com/ajax/libs/Chart.js/2.9.4/Chart.js"></script> -->
<script src="<?php echo e(asset('assets/adminlte/plugins/chart.js/Chart.js')); ?>"></script>
<script src="<?php echo e(asset('assets/adminlte/plugins/summernote/summernote-bs5.min.js')); ?>"></script>
<script>  
...
</html><?php /**PATH C:\Users\owner\OneDrive\Dokumen\KULIAH\Semester 6\RPL\Sigma Health Git\resources\views////layout.blade.php ENDPATH**/ ?>