...
<div class="tab-content" id="nav-tabContent">
      ...
      <div class="container-signup" style="width:100%">
          <div class="signin-content">
              <div class="signin-image">
                  <figure><img src="<?php echo e(asset('assets/login/images/doctor.jpg')); ?>" alt="sing up image"></figure>
              </div>

              <div class="signin-form mt-5">
                  <form method="GET" action="<?php echo e(url('pilih-poli')); ?>" class="register-form" id="login-form">
                    <?php echo csrf_field(); ?>
  ...
  <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab" tabindex="0">
    ...
    <div class="card border-0 rounded mt-4">
        <div class="card-body">
          <form action="<?php echo e(url('pendaftaran-pasien/daftar')); ?>" method="post" enctype="multipart/form-data">
          <?php echo csrf_field(); ?>
            <div class="card-body">
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" name="no_rekam_medis" id="no_rekam_medis" maxlength="16" value="<?php echo e($no_rekam_medis); ?>" readonly>
                </div>
                <div class="mb-3">
...
$(document).ready(function(){
      ...
      <?php if(session()->has('res_success')): ?>
          Swal.fire({
              position: 'center',
              icon: 'success',
              title: "<?php echo e(Session::get('res_success')); ?>",
              ...
              if (result.isConfirmed) {
                window.location.href = "<?php echo e(url('reservasi')); ?>";
              }
          })
      <?php endif; ?>
    ...
    $(function () {
      $('#provinsi').on('change', function () {
        onChangeSelect('<?php echo e(url("getKota/")); ?>', $(this).val(), 'kota', 'Kota Pasien');
      });
      $('#kota').on('change', function () {
        onChangeSelect('<?php echo e(url("getKecamatan/")); ?>', $(this).val(), 'kecamatan', 'Kecamatan Pasien');
      })
      $('#provinsi_wali').on('change', function () {
        onChangeSelect('<?php echo e(url("getKota/")); ?>', $(this).val(), 'kota_wali', 'Kota Wali');
      });
      $('#kota_wali').on('change', function () {
        onChangeSelect('<?php echo e(url("getKecamatan/")); ?>', $(this).val(), 'kecamatan_wali', 'Kecamatan Wali');
      })
    });
      // -- INDONESIA
  })
...
<?php echo $__env->make('../layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\owner\OneDrive\Dokumen\KULIAH\Semester 6\RPL\Sigma Health Git\resources\views/pages/pendaftaran-pasien.blade.php ENDPATH**/ ?>